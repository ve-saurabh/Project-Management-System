...
from .views import ProjectTaskCreateView, ProjectTaskListView, ProjectTaskUpdateView, ProjectTaskDeleteView, UpdateTaskStatus, ProjectTaskAssignView
urlpatterns = [
    ...
    path("create_team/<int:project_id>/", ProjectTeamCreateView.as_view(), name="project_team_create"),
    ...
    path('assign-task/<int:pk>/', ProjectTaskAssignView.as_view(), name="assign-task"),
